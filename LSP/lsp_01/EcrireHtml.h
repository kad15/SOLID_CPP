...
private:
	...
	std::string  FabriqueLigneTableauHtml(string legende, string contenu);
	std::string  FabriqueLigneTableauHtml(string legende, int contenu);
